...
<div class="flex flex-wrap items-center gap-2" x-data="{ copied: false }">
    ...
    <a
        ...
        class="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-elevated border border-border text-text-muted hover:text-accent hover:border-accent/50 transition-colors duration-200"
    >
    ...
    <button
        ...
        class="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-elevated border border-border text-text-muted hover:text-accent hover:border-accent/50 transition-colors duration-200"
        :class="copied && 'border-accent/50 text-accent'"
    >
